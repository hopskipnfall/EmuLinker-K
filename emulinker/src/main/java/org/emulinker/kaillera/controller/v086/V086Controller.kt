...
@Singleton
class V086Controller @Inject internal constructor(
    ...
    override val clientTypes: Array<String> = config.getStringArray("controllers.v086.clientTypes.clientType")
    ...
    init {
        ...
        serverEventHandlers = ImmutableMap.builder<Class<*>, V086ServerEventHandler<*>>()
        ...
        gameEventHandlers = ImmutableMap.builder<Class<*>, V086GameEventHandler<*>>()
        ...
        userEventHandlers = ImmutableMap.builder<Class<*>, V086UserEventHandler<*>>()
