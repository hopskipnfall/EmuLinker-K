    ...
    if (doCommand) {
      ...
      if (chatMessage.message == "/alivecheck") {
        ...
        if (space < 0) {
          try {
            clientHandler.send(
              InformationMessage(0, "server", "Invalid # of Fields!")
            )
          } catch (e: Exception) {}
          return
        }
        ...
        if (
          ...
          try {
            clientHandler.send(
              InformationMessage(0, "server", "You are silenced!")
            )
          } catch (e: Exception) {}
          return
        }
        ...
        try {
          ...
          if (user == null) {
            try {
              clientHandler.send(
                InformationMessage(0, "server", "User Not Found!")
              )
            } catch (e: Exception) {}
            return
          }
        ...
        if (foundCount == 0)
          try {
            clientHandler.send(
              InformationMessage(0, "server", "No Users Found!")
            )
          } catch (e: Exception) {}
