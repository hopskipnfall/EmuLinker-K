...
class RequestPrivateKailleraPortRequestTest : ProtocolBaseTest() {
  ...
  private companion object {
    val MESSAGE = RequestPrivateKailleraPortRequest(protocol = "0.86")

    const val BODY_BYTES = "48,45,4C,4C,4F,30,2E,38,36,00"
  }
}
