...
# Usage: curl -fsSL https://raw.githubusercontent.com/hopskipnfall/EmuLinker-K/0.15/release/setup.sh | bash
...
PROD_TXT=$(curl -s "https://raw.githubusercontent.com/hopskipnfall/EmuLinker-K/$TAG/release/prod.txt")
